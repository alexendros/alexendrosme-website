    ...
    <>
      ...
      <p>
        <strong className="text-foreground">
          alexendros.me es un sitio web estático que no instala cookies de
          ningún tipo en el dispositivo del usuario.
        </strong>{" "}
        No se utilizan cookies propias, de terceros, analíticas ni
        publicitarias. Al no existir cookies, no se requiere mecanismo de
        consentimiento.
      </p>

      <h2>Derechos del usuario</h2>
      <p>
        Aunque este sitio no utiliza cookies, el usuario conserva en todo
        momento sus derechos conforme a la normativa vigente:
      </p>
      <ul>
        <li>
          <strong className="text-foreground">
      ...
      <p>
        Si en el futuro se incorporan funcionalidades que requieran el uso de
        cookies, esta política se actualizará para reflejar los cambios y se
        implementará el mecanismo de consentimiento correspondiente conforme a
        la Guía AEPD 2023 y el Art. 22.2 LSSI-CE.
      </p>
